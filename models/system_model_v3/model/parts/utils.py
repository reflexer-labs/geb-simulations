...
def apy_to_target_rate(apy):
    return float((Decimal(apy) / 100  + 1) **(Decimal('1')/(Decimal('31536000'))) - 1)

def target_rate_to_apy(target_rate):
    return (((1 + Decimal(target_rate)) ** (60*60*24*365)) -1) * 100
